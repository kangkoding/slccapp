...
@section('title', ' SLCC PGRI WONOSOBO')
	...
	@section('content')
		...
		<!-- <div class="row section greeting-wrapper">
			<div class="col-md-12 p-0" style="padding-bottom:0px">
				<div class="container">
					<h3 class="c-blue p-20" style="padding-bottom:0px">
					...
					<div class="row p-20" style="padding-bottom:0px">
						...
						<div class="col-md-4">
							<img src="<?php echo base_url('assets/images/').settings('about_images') ?>" alt="">
						</div>
					</div>
				</div>
			</div>
		</div> -->
		<!-- <div class="row section" style="border-top:0px;display:none">
			<div class="container p-20">
				<div class="col-md-2 col-xs-6 mB-10"><a href="" class="btn btn-primary btn-block">Tombol</a></div>
				<div class="col-md-2 col-xs-6 mB-10"><a href="" class="btn btn-primary btn-block">Tombol</a></div>
				<div class="col-md-2 col-xs-6 mB-10"><a href="" class="btn btn-primary btn-block">Tombol</a></div>
				<div class="col-md-2 col-xs-6 mB-10"><a href="" class="btn btn-primary btn-block">Tombol</a></div>
				<div class="col-md-2 col-xs-6 mB-10"><a href="" class="btn btn-primary btn-block">Tombol</a></div>
								...
								<div class="col-md-{{$arrayCol[$i]['col']}}">
									<div class="panel panel-sidebar" style="background-color:rgba(0,0,0,0)">
							            <div class="panel-heading" style="border-bottom:solid 3px #00BCD4">
							                <h3 class="panel-title" style="background-color:#00BCD4">{{ $item['title'] }} </h3>
							            </div>
										...
										<div class="panel-footer">
										    <a class="btn btn-primary btn-xs" href="{{base_url('post/kategori/'.$item['slug'])}}">Lainya</a>
										</div>
									</div>
								</div>
							<?php $i++;endforeach ?>
