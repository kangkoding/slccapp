...
class Header_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->from('header');
        //add this line for join
        //$this->datatables->join('table2', 'header.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('admin/header/update/$1'),'Update'), 'id');
